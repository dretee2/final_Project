...
class App(Driver):
    ...
    def tap(self, locator, **kwargs):
        ...
        element = App.element(self, locator) if 'index' not in kwargs else App.elements(self, locator)[kwargs['index']]
    ...
    def swipe(self, start, dest):
        ...
        # Replace legacy tap_by_coordinates
